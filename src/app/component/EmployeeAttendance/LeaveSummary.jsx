        ...
        <div>
            <div className="w-full h-full mt-4 md:mt-0 p-6 bg-white rounded-lg shadow-lg">
                ...
                <div className=''>
                    <div className='flex'>
                        <div className='w-1/2'>
                            <h5 className='text-lg text-gray-600'>Total Leaves</h5>
                            <p className='text-lg font-bold'>40</p>
                        </div>
                        <div className='w-1/2'>
                            <h5 className='text-lg text-gray-600'>Taken</h5>
                            <p className='text-lg font-bold'>18</p>
                        </div>
                    </div>
                    <div className='flex mt-2'>
                        <div className='w-1/2'>
                            <h5 className='text-lg text-gray-600'>Absent</h5>
                            <p className='text-lg font-bold'>2</p>
                        </div>
                        <div className='w-1/2'>
                            <h5 className='text-lg text-gray-600'>Request</h5>
