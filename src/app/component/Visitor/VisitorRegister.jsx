...
const VisitorRegister = ({ user }) => {
    ...
    const handleInsertVisitor = (data) => {
        ...
        setLoading(true)
        fetch(`${process.env.API_SERVER_URL}/visitor`, {
            method: "POST",
            headers: {
    ...
    return (
        <div>
            ...
            <div className='flex gap-x-2'>
                <Calendar onChange={(e) => { setSelectedMonth((e.value)); console.log(e.value); }} value={selectedMonth} view="month" dateFormat="MM" size='small' />
