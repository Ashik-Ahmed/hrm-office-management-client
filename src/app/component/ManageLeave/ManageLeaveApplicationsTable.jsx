...
const ManageLeaveApplicationsTable = ({ user }) => {
    ...
    const fetchLeaveApplications = () => {
        setLoading(true)
        fetch(`${process.env.API_SERVER_URL}/leaveApplication?year=${selectedYear}&status=${currentStatus || ''}`, {
            headers: {
    ...
    const approveLeaveApplicationStatus = (status) => {
        ...
        fetch(`${process.env.API_SERVER_URL}/leaveApplication/${approveDialog._id}`, {
            method: "PATCH",
            headers: {
    ...
    const rejectLeaveApplication = (data) => {
        ...
        fetch(`${process.env.API_SERVER_URL}/leaveApplication/${rejectDialog._id}`, {
            method: "PATCH",
            headers: {
                "content-type": "application/json",
                "Authorization": `Bearer ${user?.accessToken}`
