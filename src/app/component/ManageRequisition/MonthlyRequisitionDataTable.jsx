...
const MonthlyRequisitionDataTable = ({ user }) => {
    ...
    const getRequisitionDetails = (requisitionId) => {
        setLoading(true)
        fetch(`${process.env.NEXT_PUBLIC_API_SERVER_URL}/requisition/${requisitionId}`, {
            headers: {
    ...
    const handleCancelRequisition = (requisitionId) => {
        setLoading(true);
        const url = `${process.env.NEXT_PUBLIC_API_SERVER_URL}/requisition/cancelRequisition/${requisitionId}`;
        // console.log(url);
        fetch(url, {
            method: "PATCH",
            headers: {
        ...
        <div>
            ...
            <div className='mt-1 shadow-lg p-2 bg-white rounded-md'>
                <div className='flex items-center gap-x-2 mb-2'>
                    <h3 className='font-light'>REQUISITION REPORT</h3>
