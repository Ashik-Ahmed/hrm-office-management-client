    ...
    const exportToPDF = () => {
        import('jspdf').then(jsPDF => {
            import('jspdf-autotable').then(() => {
                ...
                doc.setFontSize(11);
                doc.text(`Report Month:`, 30, 45);
                doc.text(`Total Requisition: `, 30, 55);
                doc.text(`Report Generated: ${year}-${month}-${day}`, 30, 65);
                doc.text(`Generated By: `, 30, 75);

                doc.text(`Required Amount: `, 200, 45);
                doc.text(`Purchased Amount: `, 200, 55);
                doc.text(`Required Items: `, 200, 65);
                doc.text(`Purchased Items: `, 200, 75);
